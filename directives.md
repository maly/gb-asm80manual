...
|  | Macros and blocks |
| .macro_macro\_name_ | Defines a macro, see[the chapter about macros](https://maly.github.io/asm80-node/#macros). |
| .rept_count_ | Repeat a block of code substituing arguments. See[the chapter about macros](https://maly.github.io/asm80-node/#macros). |
